...
<head>
    ...
    <link rel="stylesheet" href="/tienda/tienda.min.css?v=11">
...
{COMUNES}
    ...
    <script src="/tienda/productos.min.js?v=11" defer></script>
    <script src="/tienda/app.min.js?v=11" defer></script>
    ...
    <script src="/tienda/live.min.js?v=11" defer></script>
    <script src="/tienda/cuenta.min.js?v=11" defer></script>
</body>
</html>
'''
